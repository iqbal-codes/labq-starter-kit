...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    // eslint-disable-next-line react-doctor/no-document-view-transition -- React 19 ViewTransition wrapper cannot express the polygon-clip custom animation this component implements

...
function FieldError({
  ...
  // eslint-disable-next-line react-doctor/rerender-memo-before-early-return -- useMemo must precede all returns per React hook rules; the early return guard below ensures no wasteful render

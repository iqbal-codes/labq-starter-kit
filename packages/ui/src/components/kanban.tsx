...
// ---------------------------------------------------------------------------
// KanbanBoard — renders the columns container with SortableContext
// ---------------------------------------------------------------------------
    ...
    <KanbanBoardContext.Provider value={true}>
      ...
      >
        <BoardPrimitive
          ...
          className={cn(
            "flex min-w-0 gap-4",
            context.orientation === "horizontal" ? "flex-row items-start" : "flex-col",
            className,
          )}
        />
      </SortableContext>
...
// ---------------------------------------------------------------------------
// KanbanColumn — sortable column wrapper with nested SortableContext
// ---------------------------------------------------------------------------
    ...
    <KanbanColumnContext.Provider value={columnContext}>
      ...
      >
        <ColumnPrimitive
          ...
          style={composedStyle}
          className={cn(
            "flex min-w-0 flex-col gap-2 rounded-lg border bg-zinc-100 p-2.5 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:bg-zinc-900",
            {
...
// ---------------------------------------------------------------------------
// KanbanColumnHandle — button drag handle extracted from column
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// KanbanItemHandle — button drag handle extracted from item
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// KanbanOverlay — portal-based DragOverlay
// ---------------------------------------------------------------------------

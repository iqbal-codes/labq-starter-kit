...
const { useAppForm, withForm, withFieldGroup } = createFormHook({
  ...
  formComponents: {
    ...
    AvatarUploadField: FormAvatarUploadField,
    PhotoUploadField: FormPhotoUploadField,
...
function useFormFields<TValues extends Record<string, unknown>>() {
  ...
  return {
    ...
    FormAvatarUploadField: FormAvatarUploadField as unknown as Typed<typeof FormAvatarUploadField>,
    FormPhotoUploadField: FormPhotoUploadField as unknown as Typed<typeof FormPhotoUploadField>,

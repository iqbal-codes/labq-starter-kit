...
1. Prefer `@labq-modules/ui` primitives and compose from them instead of styling one-off controls from scratch.
...
5. Forms use the TanStack Form patterns from `@labq-modules/ui/components/forms/tanstack-form`.
...
10. Empty states should use `@labq-modules/ui/components/empty` when a reusable no-data presentation is needed.
